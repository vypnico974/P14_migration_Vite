# P14 OpenClassrooms Wealth Health - solution nr 1 migré Vite.
...
plusieurs améliorations possible qui sont actuellement désactivées (en commentaire dans le code de l'application) : 
- champs obligatoires
- règle de saisies
...
de fichier des dépendances React pour permettre l'amélioration de la performance en terme d'affichage ([voir le fichier vite.config.js](https://github.com/vypnico974/P14_migration_Vite/blob/main/vite.config.js)).
